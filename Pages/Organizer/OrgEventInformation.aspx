                ...
                <div class="form-field">
                    <p>Preferred Information of Participants:</p>
                        <asp:CheckBoxList ID="cbl_targetData" runat="server" Width="100%" CssClass="check-boxs" RepeatLayout="UnorderedList">
                            ...
                            <asp:ListItem Enabled="False" Value="middleName">Middle Name</asp:ListItem>
                            <asp:ListItem Enabled="False" Selected="True" Value="lastName">Last Name</asp:ListItem>
                            <asp:ListItem  Enabled="False" Value="userID" >Student No.</asp:ListItem>
                            <asp:ListItem  Enabled="False" Value="contactNo">Contact No.</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="email">E-mail</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="college">College</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="course">Course</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="year">Year Level</asp:ListItem>
                    </asp:CheckBoxList>
                 </div>
                <div class="form-field">
                    <p>Participants:</p>
