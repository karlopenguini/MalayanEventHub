<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/AdminView.Master" AutoEventWireup="true" CodeBehind="OrgRequestPage.aspx.cs" Inherits="MalayanEventHub.Layouts.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../../Styles/Admin/StyleSheetOrgReqPage.css" rel="stylesheet" />
    <style>
        .header{
            font-size:1.6em;
            font-weight:300;
