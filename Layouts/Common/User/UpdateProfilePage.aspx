...
<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/Common/User/AccountDetailsView.master" AutoEventWireup="true" CodeBehind="UpdateProfilePage.aspx.cs" Inherits="MalayanEventHub.Layouts.Common.User.WebForm1" %>
        ...
        <div class="child-container">
            <table>
                ...
                <tr style="border: solid">
                    ...
                    <td>
                        <asp:DropDownList CssClass="ddl" ID="ddl_college" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList CssClass="ddl" ID="ddl_course" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList CssClass="ddl" ID="ddl_yearLevel" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>
